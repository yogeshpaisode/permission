...
<html lang="en">
    <head>
        <title>Track Permission Status</title>
        <meta charset="utf-8">
    ...
    <body style="background-image:url('img/5.jpg');">
        ...
        <br><br><br><br><br>
        <%
            String trackErrorMsg = "";

            if (!(session.getAttribute("trackErrorMsg") == null)) {
                trackErrorMsg = (String) session.getAttribute("trackErrorMsg");
            }
        ...
        <table>
            <tr>
                ...
                <td style="color:black; background-color:#dff0d8;width:74%;" align="center">
                    ...
                    <% out.print(trackErrorMsg);%>
                    <br>
                    <h4>Please Provide Your Permission Id Below</h4>


                    <form role="form" action="trackxxxsgwf63eedge3d674ehe3bdj3end3ediojed88r8rr4r8uhdu4fu4yf857f75f74f4yrfgr4f85f75f75f7fg4yufgdbhe3bde3d7f7yfg4yuyue3e3uge3dgey.jsp" method="post">
