 ...
 * @author Yogesh
 */
public class SendConfirmation_Email implements Runnable {
    ...
    public SendConfirmation_Email(String receiver, String name, String id,String filePath) {
        try {
    ...
    public void sendEmail() {
        ...
        filename = "e-permission.pdf";
        String host = "mail.malanicombines.in";
        String to = receiver;
        String subject = "You Have Applied For Permission Successfully";
